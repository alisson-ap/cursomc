...
import com.magalhaes.cursomc.dto.ProdutoDTO;
import com.magalhaes.cursomc.resources.utils.URL;
...
public ResponseEntity<Page<ProdutoDTO>> FindPage(
	...
	Page<Produto> list = prodServ.search(nomeDecoded ,ids, page, linesPerPage, orderBy, direction);
